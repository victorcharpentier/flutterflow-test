...
import 'sign_up_info1_model.dart';
export 'sign_up_info1_model.dart';

class SignUpInfo1Widget extends StatefulWidget {
  const SignUpInfo1Widget({
    super.key,
    required this.email,
  ...
  @override
  _SignUpInfo1WidgetState createState() => _SignUpInfo1WidgetState();
}

class _SignUpInfo1WidgetState extends State<SignUpInfo1Widget> {
  late SignUpInfo1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignUpInfo1Model());
